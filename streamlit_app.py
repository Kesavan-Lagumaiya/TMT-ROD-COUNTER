...
if uploaded_file is None:
    # Default image.
    url = 'https://github.com/Kesavan-Lagumaiya/TMT-ROD-COUNTER/blob/main/image%20samples/122483295-reinforcing-bars-with-a-periodic-profile-in-the-packs-are-stored-in-the-metal-products-warehouse.jpg?raw=true'
...
upload_url = ''.join([
    'https://infer.roboflow.com/LeP6vbyLZw4bf2vOH4fR',
